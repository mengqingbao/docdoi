package com.docdoi.persistence;
...
import com.docdoi.database.DBHelper;
...
public class BaseDao {
	...
	protected SQLiteDatabase getDb(boolean isRead,Context context) {
		...
		//return SQLiteDatabase.openOrCreateDatabase("data/data/com.docdoi.activity/databases/mydata.db", null);
	}
}
